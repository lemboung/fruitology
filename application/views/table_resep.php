      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Edit & Hapus Resep</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Edit & Hapus Resep</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo base_url()."resep_edit/edit_menu/".$d['id_resep']; ?>">Edit</a>
                          <a href="<?php echo base_url()."resep_edit/do_delete/".$d['id_resep']; ?>">Delete</a>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
