  ...
  <body class="hold-transition skin-green-light sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Tabel Bahan
            <small>Edit & Hapus bahan</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Update and Delete</a></li>
            <li class="active">Edit & Hapus Bahan</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Edit & Hapus Bahan</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php if ($d['gambar_bahan'] != "") { ?>
                          <td><center><img src="<?php echo base_url("/assets/image/bahan/$d[gambar_bahan]");?>" style="height: 100px; width: 100px"/></center></td>
                        <?php } else { ?>
                          <td>no image</td>
                        <?php } ?>
                        <td><?php echo $d['judul_resep']; ?></td>
                        <td>
                          <a href="<?php echo base_url()."bahan_edit/edit_bahan/".$d['id_bahan']; ?>">Edit</a>
                          <a href="<?php echo base_url()."bahan_edit/do_delete/".$d['id_bahan']; ?>">Delete</a>
                        </td>
                      </tr>
                      <?php } ?>
                    </tbody>
