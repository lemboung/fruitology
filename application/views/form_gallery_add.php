          ...
          <div class="row">
            ...
            <div class="col-md-push-3 col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo base_url()."gallery_add/do_insert"; ?>" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama Gambar</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Gambar" name="nama_pict" required>
                    </div>
                    <div class="form-group">
                      <label>Deskripsi Gambar</label>
                      <textarea class="form-control" rows="3" placeholder="Masukkan Deskripsi Gambar" name="deskripsi"></textarea>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                      <label>Gambar</label>
                      <input type="file" id="exampleInputFile" name="pict_gallery" required>
