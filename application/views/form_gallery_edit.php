      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Edit & Hapus gallery</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-push-3 col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo base_url()."gallery_edit/do_update"; ?>" enctype="multipart/form-data">
                  <input type="text" name="id_gallery" value="<?php echo "$data[id_gallery]"; ?>" hidden/>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama Gambar</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama buah" name="nama_pict" value="<?php echo "$data[nama_pict]"; ?>" required>
                    </div>
                    <div class="form-group">
                      <label>Deskripsi Gambar</label>
                      <textarea class="form-control" rows="3" placeholder="Masukkan manfaat buah" name="deskripsi"><?php echo "$data[deskripsi]"; ?></textarea>
                    </div>
                    <!-- PENTING!!! -->
                    <div class="form-group">
                      <label>Gambar</label>
                      <?php if ($data['pict_gallery'] != "") { ?>
                        <center><br><img src="<?php echo base_url("/assets/image/galeri/$data[pict_gallery]"); ?>" style="height: 100px; width: 100px"><br><small>preview image</small><br></center>
                      <?php } else{ ?>
                        <center><br>no image<br><small>preview image</small><br></center>
                      <?php } ?>
                      <input type="file" id="exampleInputFile" name="pict_gallery">
