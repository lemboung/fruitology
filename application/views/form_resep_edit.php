      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Edit & Hapus Resep</a></li>
            ...
            <div class="col-md-push-3 col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Resep</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo base_url()."resep_edit/do_update"; ?>" enctype="multipart/form-data">
                  <input type="text" name="id_resep" value="<?php echo "$data[id_resep]"; ?>" hidden/>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama Resep</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Resep" name="judul_resep" value="<?php echo "$data[judul_resep]"; ?>" required>
                    </div>
                  </div><!-- /.box-body -->
