          ...
          <div class="row">
            ...
            <div class="col-md-push-3 col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" method="POST" action="<?php echo base_url()."bahan_add/do_insert"; ?>" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama bahan</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama bahan" name="bahan" required>
                    </div>
                    <div class="form-group">
                      <label>Resep</label>
                    ...
                    <div class="form-group">
                      <label>Penjelasan bahan</label>
                      <textarea class="form-control" rows="3" placeholder="Masukkan Deskripsi bahan" name="deskripsi"></textarea>
                    </div>
                    <!-- <div class="form-group">
